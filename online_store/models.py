...
class Product(models.Model):
    ...
    category_name = models.CharField(max_length=100, null=False, verbose_name='Категория', choices=CategoryChoice.choices, default=CategoryChoice.OTHER)
    residue = models.PositiveIntegerField(verbose_name='Остаток', null=True)
