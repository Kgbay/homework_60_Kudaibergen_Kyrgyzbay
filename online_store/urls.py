...
from online_store.views.products import product_view, product_add_view, product_remove_view, product_confirm_remove_view, product_update_view
from online_store.views.categories import category_add_view, category_view, category_remove_view, category_confirm_remove_view, category_update_view
...
urlpatterns = [
    ...
    path("categories/<int:pk>/confirm_remove/", category_confirm_remove_view, name='confirm_remove_category'),

    path("products/<int:pk>/remove/", product_remove_view, name='remove_product'),
    path("products/<int:pk>/confirm_remove/", product_confirm_remove_view, name='confirm_remove_product'),
